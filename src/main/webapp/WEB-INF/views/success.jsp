...
<head>
    ...
    <link rel="stylesheet" href="D:\Data\Java\PurchaseTime\src\main\resources\static\signin.css">
    <link rel="canonical" href="https://getbootstrap.com/docs/5.1/examples/sign-in/">

    <meta charset="UTF-8">
    <title><% out.println(LanguageSupportService.get("apptitle",lang)); %></title>
    <style>
        .bd-placeholder-img {
            font-size: 1.125rem;
            text-anchor: middle;
